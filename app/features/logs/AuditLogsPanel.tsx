...
export default function AuditLogsPanel({ logs, setLogs, selectedLogIds, setSelectedLogIds, setNotice, loadState }: AuditLogsPanelProps) {
  const { pageItems: pagedLogs, page, pageSize, total, setPage } = usePaged(logs, 20);
